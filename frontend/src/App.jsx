    ...
    <BrowserRouter>
      <div className="min-h-screen bg-gray-100">
        ...
        <Routes>
          ...
          {/* ════════ PLAYER ════════ */}
          <Route path="/player-dashboard" element={<ProtectedRoute allowedRole="player"><PlayerDashboard /></ProtectedRoute>} />
          <Route path="/my-bookings"      element={<ProtectedRoute allowedRole="player"><PlayerMyBookings /></ProtectedRoute>} />
          <Route path="/my-payments"      element={<ProtectedRoute allowedRole="player"><PlayerPaymentHistory /></ProtectedRoute>} />
          <Route path="/notifications"    element={<ProtectedRoute allowedRole="player"><PlayerNotifications /></ProtectedRoute>} />

          {/* ════════ OWNER ════════ */}
          <Route path="/owner-dashboard"    element={<ProtectedRoute allowedRole="owner"><OwnerDashboard /></ProtectedRoute>} />
          <Route path="/add-ground"         element={<ProtectedRoute allowedRole="owner"><OwnerAddGround /></ProtectedRoute>} />
          <Route path="/manage-grounds"     element={<ProtectedRoute allowedRole="owner"><OwnerManageGround /></ProtectedRoute>} />
          ...
          <Route path="/admin/grounds"      element={<ProtectedRoute allowedRole="admin"><AdminGroundApproval /></ProtectedRoute>} />
          <Route path="/admin/ground/:id"   element={<ProtectedRoute allowedRole="admin"><AdminGroundDetail /></ProtectedRoute>} />
