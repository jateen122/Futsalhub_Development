...
const validate = (form) => {
  ...
  if (!form.price_per_hour || isNaN(price) || price <= 0)
    e.price_per_hour = "Enter valid price.";
  return e;
};
...
const iCls = (err) =>
  `w-full rounded-lg px-4 py-3 text-sm font-medium text-gray-800 bg-white
   border placeholder-gray-400 focus:outline-none transition-all
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative bg-white border border-gray-200 rounded-xl p-8 max-w-md w-full shadow-2xl">
        ...
        <p className="text-gray-500 text-center text-sm mb-6">
          <strong className="text-gray-800">{ground.name}</strong> will be
          permanently removed.
        </p>
...
export default function OwnerManageGround() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 pt-24 px-4 flex items-center justify-center">
        <div className="text-center max-w-sm">
          <div className="w-20 h-20 rounded-2xl bg-green-50 border border-green-200 flex items-center justify-center mx-auto mb-5">
            <svg
          ...
          <p className="text-gray-500 text-sm mb-6">
            You haven't listed any grounds yet. Add one to start receiving
            bookings.
          </p>
          <button
            onClick={() => navigate("/add-ground")}
            className="px-8 py-3 bg-green-500 text-white font-black rounded-lg hover:bg-green-600 transition shadow-sm"
          >
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      {/* toast */}
      {toast && (
        <div className="fixed top-24 left-1/2 -translate-x-1/2 z-50 bg-white border border-green-300 text-green-700 px-6 py-3 rounded-lg shadow-xl text-sm font-semibold flex items-center gap-2 whitespace-nowrap">
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="bg-gray-100 text-gray-600 text-xs font-bold px-2.5 py-1 rounded border border-gray-200 ml-1">
            {grounds.length} ground{grounds.length > 1 ? "s" : ""}
          </span>
        </div>
        <button
          onClick={() => navigate("/add-ground")}
          className="px-4 py-2 bg-green-500 text-white rounded-lg text-sm font-bold hover:bg-green-600 transition shadow-sm flex items-center gap-1.5"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            <path
              fillRule="evenodd"
                ...
                <div className="flex items-center gap-6 p-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-1.5">
                      ...
                      <span
                        className={`px-3 py-1 rounded text-xs font-bold border flex-shrink-0
                        ${
                          g.is_approved
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-xs">
                      ...
                      <span className="text-gray-500">
                        {toLabel(fromBackendTime(g.opening_time?.slice(0, 5)))}{" "}
                        –{" "}
                        {toLabel(fromBackendTime(g.closing_time?.slice(0, 5)))}
                      </span>
                      {g.facilities && (
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <button
                      onClick={() => openEdit(g)}
                      className="flex items-center gap-2 px-5 py-2.5 bg-green-50 border border-green-200 text-green-700 rounded-lg text-sm font-bold hover:bg-green-100 transition"
                    >
                      Edit
                    </button>
                    <button
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 text-xs">
                          Fields you don't change stay the same
                        </p>
                      </div>
                    </div>
                    <button
                      type="button"
                      onClick={closeEdit}
                      className="w-8 h-8 rounded-lg bg-white border border-gray-200 text-gray-500 hover:bg-gray-100 transition flex items-center justify-center text-sm font-bold shadow-sm"
                    >
                      ✕
                    </button>
                  </div>
                  ...
                  <div className="p-6">
                      ...
                      <div className="col-span-12 lg:col-span-7 space-y-4">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            rows={3}
                            placeholder={
                              g.description || "Describe your ground..."
                            }
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            ...
                            <input
                              ...
                              onChange={handleChange}
                              placeholder={g.facilities || "Parking, Shower..."}
                          ...
                          <div>
                            ...
                            <div
                              ...
                              ${errors.price_per_hour ? "border-red-400 ring-1 ring-red-200" : "border-gray-300 focus-within:border-green-500 focus-within:ring-1 focus-within:ring-green-200 hover:border-gray-400"}`}
                            >
                              <span className="px-3 py-3 text-gray-500 font-bold text-sm bg-gray-50 border-r border-gray-200 select-none">
                                Rs
                              </span>
                              <input
                                type="number"
                              ...
                              />
                              <span className="px-3 text-gray-400 text-xs bg-gray-50 border-l border-gray-200 py-3 select-none">
                                /hr
                              </span>
                            </div>
                        ...
                        {/* time pickers */}
                        <div>
                          <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 border-t border-gray-100 pt-4">
                            Operating Hours
                          </p>
                          <div className="grid grid-cols-2 gap-4">
                            <TimePicker
                          ...
                          {form.opening_time?.hour &&
                            form.closing_time?.hour && (
                              <div className="mt-3 bg-green-50 border border-green-200 rounded-lg px-4 py-2.5 flex items-center gap-2">
                                ...
                                <p className="text-green-700 font-semibold text-sm">
                                  {toLabel(form.opening_time)} –{" "}
                                  {toLabel(form.closing_time)}
                                </p>
                              </div>
                            )}
                        </div>
                            ...
                            <div className="relative group rounded-lg overflow-hidden border-2 border-green-400 h-36">
                              ...
                              <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition flex items-center justify-center">
                                <button
                                  ...
                                  className="px-3 py-1.5 bg-white text-gray-700 text-xs rounded font-semibold shadow hover:bg-gray-100 transition"
                                >
                                  Remove
                                </button>
                              </div>
                              <span className="absolute bottom-2 right-2 bg-green-500 text-white text-xs px-2 py-0.5 rounded font-bold">
                                New
                              </span>
                            </div>
                          ) : (
                    ...
                    <div className="flex gap-3 mt-6 pt-5 border-t border-gray-100">
                      ...
                      <button
                        type="button"
                        onClick={() => setDeleteTarget(g)}
                        className="px-6 py-3 bg-red-50 border border-red-200 text-red-600 rounded-lg font-bold hover:bg-red-100 transition text-sm"
                      >
                        Delete
                      </button>
                      <button
