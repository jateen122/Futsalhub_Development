  ...
  return (
    <div className="bg-zinc-50 text-zinc-950">
      ...
      <section className="pt-32 pb-28 text-center px-6">
        ...
        <p className="max-w-5xl mx-auto text-2xl text-zinc-600 leading-relaxed">
      ...
      <section className="py-28 px-6 lg:px-24">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="bg-white border border-zinc-200 p-10 rounded-3xl hover:scale-105 hover:shadow-2xl transition">
      ...
      {/* FOOTER */}
      <footer className="border-t border-zinc-200 text-center py-8 text-zinc-500 text-lg">
